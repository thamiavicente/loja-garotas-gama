...
namespace Girls.Gama2
{
    class Program
    {
        ...
        public static void Comprar()
        {
            ...
            Console.WriteLine("Digite o valor da descrição:");
            var descricao = Console.ReadLine();

            var boleto = new Boleto(cpf, valor, descricao);
            boleto.GerarBoleto();

            Console.WriteLine($"Boleto gerado com sucesso com o número {boleto.CodigoBarra}" +
                              $"com data de vencimento para o dia {boleto.DataVencimento}" +
                              $"");
